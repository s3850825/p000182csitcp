...
class Ui_Send_Message(object):
    def setupUi(self, SendMessage):
        ...
        self.EncryptAndSignButton.setGeometry(QtCore.QRect(220, 490, 255, 51))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(16)
        self.EncryptAndSignButton.setFont(font)
        self.EncryptAndSignButton.setObjectName("EncryptAndSignButton")
        self.EncryptAndSignButton.setStyleSheet("color: rgb(255, 255, 255);\n""background-color: rgb(0, 85, 255);")
        ...
        self.EncryptButton.setGeometry(QtCore.QRect(220, 560, 255, 51))
        self.EncryptButton.setFont(font)
        self.EncryptButton.setObjectName("EncryptButton")
        self.EncryptButton.setStyleSheet("color: rgb(255, 255, 255);\n""background-color: rgb(0, 85, 255);")
        self.SignatureButton = QtWidgets.QPushButton(SendMessage)
        self.SignatureButton.setGeometry(QtCore.QRect(220, 630, 255, 51))
        self.SignatureButton.setFont(font)
        self.SignatureButton.setObjectName("SignatureButton")
        self.SignatureButton.setStyleSheet("color: rgb(255, 255, 255);\n""background-color: rgb(0, 85, 255);")
