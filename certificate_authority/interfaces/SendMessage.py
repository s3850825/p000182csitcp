...
class Ui_Send_Message(object):
    def setupUi(self, SendMessage):
        ...
        self.EncryptAndSignButton.setGeometry(QtCore.QRect(270, 490, 155, 51))
        font = QtGui.QFont()
        ...
        self.EncryptButton.setGeometry(QtCore.QRect(270, 560, 155, 51))
        self.EncryptButton.setFont(font)
        self.EncryptButton.setObjectName("EncryptButton")
        self.SignatureButton = QtWidgets.QCommandLinkButton(SendMessage)
        self.SignatureButton.setGeometry(QtCore.QRect(270, 630, 155, 51))
